...
public class gonggaoAction extends ActionSupport
{
	...
	public String gonggaoAll()//首页-所有公告
	{
	...
	public String gonggaoQian5()//首页-显示公告前3
	{
		List gonggaoList=gonggaoDAO.findAll();
	...
	public String gonggaoDetailQian()//首页-公告详情
	{
		TGonggao gonggao=gonggaoDAO.findById(gonggaoId);
		Map request=(Map)ServletActionContext.getContext().get("request");
		request.put("gonggao", gonggao);
	...
	public String gonggaoYisheng()//专家-显示公告详情
	{
		TGonggao gonggao=gonggaoDAO.findById(gonggaoId);
		Map request=(Map)ServletActionContext.getContext().get("request");
		request.put("gonggao", gonggao);
	...
	public String gonggaoYisheng5()//专家-显示公告前3
	{
		List gonggaoList=gonggaoDAO.findAll();
		if(gonggaoList.size()>3)
		{
	...
	public String gonggaoYishengAll()//专家-所有公告
	{
