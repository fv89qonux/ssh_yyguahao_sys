...
public class TYishengDAO extends HibernateDaoSupport
{
	...
	public static final String YISHENG_PW = "yishengPw";
	...
	public static final String YISHENG_ZHICHENG = "yishengZhicheng";
	
	public static final String YISHENG_PHOTO = "yishengPhoto";
	
	public static final String YISHENG_ZHUANCHANG = "yishengZhuanchang";
...
//		}
	...
	public List findByYishengPw(Object yishengPw)
	{
		return findByProperty(YISHENG_PW, yishengPw);
	}
	...
	public List findByYishengZhicheng(Object yishengZhicheng)
	{
		return findByProperty(YISHENG_ZHICHENG, yishengZhicheng);
	}
	
	public List findByYishengPhoto(Object yishengPhoto)
	{
		return findByProperty(YISHENG_PHOTO,yishengPhoto);
	}
	
	public List findByYishengZhuanchang(Object yishengZhuangchang)
	{
		return findByProperty(YISHENG_ZHUANCHANG,yishengZhuangchang);
	}
