...
public class TKeshiDAO extends HibernateDaoSupport//继承HibernateDaoSupport类 操纵数据库，不用关心事务
{
	//Log日志：新创建一个log用来存放TKeshiDAO.class的Log信息
	private static final Log log = LogFactory.getLog(TKeshiDAO.class);

	public static final String KESHI_NAME = "keshiAnme";
