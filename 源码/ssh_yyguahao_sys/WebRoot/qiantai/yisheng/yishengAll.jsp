    ...
    <script language="JavaScript" type="text/javascript">
       function yuyue(yishengId)
       {
            ...
            <s:else>
					...
					var ret = window.open(url,"","dialogWidth:500px; dialogHeight:350px; dialogLeft: status:no; scrollbars:yes;Resizable=no;");
            </s:else>
       }
    </script>
  </head>
...
<div id="MainCenter" align="center" class="MainCenter">
		 ...
		 <div id="content" class="Sub">
				<div class="NewContainer">
					<div class="BoxHeader">
						<div class="BoxHeader-center MarginTop">专家预约</div>
					</div>
					<div class="Slot">
						<table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
							...
							<tr align='center' bgcolor="#FFFFFF" height="22">
								<td bgcolor="#FFFFFF" align="center">
									 <img src="<%=path %>/img/<s:property value="#yisheng.yishengPhoto"/>">
								</td>
								<td bgcolor="#FFFFFF" align="center">
