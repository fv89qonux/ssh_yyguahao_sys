    ...
    <body onload="showTime(time)">
        <table width="170" border="0" align="center" cellspacing="1">   
            <tr height="25" bgcolor="#F0F0F0" align="center" style="font-size: 12px;">
                <td style="border:1 solid"><font color=red>日</font></td>
                ...
                <td style="border:1 solid"><font color=red>六</font></td>
            </tr>
            ...
            <tr style="font-size: 12px;">
                 ...
                 <% for(int i=j*7;i<(j+1)*7;i++) { 
                      ...
                      <td width="30" height="23" align="center" bgcolor="#F0F0F0" style="border:1 solid">
                      <font color="red"><b><%=days[i]%></b></font>
                      </td>
                <%    }else{ %>
                      <td width="30" height="23" align="center" style="border:1 solid">
                      <%=days[i]%>
                      </td>
                <%    }
                  }%>
