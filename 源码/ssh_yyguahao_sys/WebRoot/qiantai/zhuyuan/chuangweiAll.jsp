...
<html>
  <head>
    ...
    <script language="JavaScript" type="text/javascript">
       function yuyueZhuyuan(chuangweiId)
       {
            ...
            <s:else>
                    var url="<%=path %>/qiantai/zhuyuan/yuyueZhuyuan.jsp?chuangweiId="+chuangweiId;
					var ret = window.open(url,"","dialogWidth:500px; dialogHeight:400px; dialogLeft: status:no; directories:yes;scrollbars:yes;Resizable=no;");
            </s:else>
       }
    </script>
  </head>
...
<div id="MainCenter" align="center" class="MainCenter">
		 ...
		 <div id="content" class="Sub">
				<div class="NewContainer">
					<div class="BoxHeader">
						<div class="BoxHeader-center MarginTop">床位预约</div>
					</div>
					<div class="Slot">
						<table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
							...
							<tr align='center' bgcolor="#FFFFFF"  height="22">
								...
								<td bgcolor="#FFFFFF" align="center">
									 <s:property value="#chuangwei.chuangweiPrice"/>
								</td>
								<td bgcolor="#FFFFFF" align="center">
								...
								<td bgcolor="#FFFFFF" align="center">
									 ...
									 <a href="#" onclick="yuyueZhuyuan(<s:property value="#chuangwei.chuangweiId"/>)">预约</a>
								</td>
							</tr>
							</s:iterator>
						</table>
