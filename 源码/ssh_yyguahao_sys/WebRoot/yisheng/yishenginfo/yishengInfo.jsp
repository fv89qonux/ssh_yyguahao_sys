...
<html>
  <head>
    ...
    <script language="JavaScript" type="text/javascript">
       function gotoEdit()
       {
            var url="<%=path %>/yishengInfoEdit.action";
	     ...
	     <div id="right" class="right">
	 	 ...
	 	 <div id="content" class="Sub">
				<div class="NewContainer">
					<div class="BoxHeader">
						<div class="BoxHeader-center MarginTop">医生个人信息</div>
					</div>
					<div class="Slot">
					  <table width="70%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:5px;margin-bottom:5px" >
					    ...
					    <tr>
						   ...
						   <td width=35% bgcolor="#FFFFFF">
							   &nbsp;
                               <font style="font-size: 12px;">${sessionScope.yisheng.yishengName }
						   </td>
						   <td  width=15% height="30" align="right" bgcolor="#F9F9F9" style="font-size: 12px;">
						   	  密 码：
						   </td>
						   <td width=35% bgcolor="#FFFFFF">
							      &nbsp;
							   <font style="font-size: 12px;">${sessionScope.yisheng.yishengPw }
						   </td>
					    </tr>
	                    ...
	                    <tr>
						   ...
						   <td bgcolor="#FFFFFF">
							  &nbsp;
							  <font style="font-size: 12px;">${sessionScope.yisheng.keshiId }
						   </td>
						   <td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 12px;">
							   医生ID：
						   </td>
						   <td bgcolor="#FFFFFF">
							  &nbsp;
							  <font style="font-size: 12px;">${sessionScope.yisheng.yishengId }
						   </td>
					    </tr>
					    <tr>
						   <td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 12px;">
					  	   ...
					  	   <td bgcolor="#FFFFFF" >
							  &nbsp;
							  <font style="font-size: 12px;">${sessionScope.yisheng.yishengAge }
						   </td>
						   <td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 12px;">
							   性 别：
						   </td>
						   <td bgcolor="#FFFFFF">
							  &nbsp;
							  <font style="font-size: 12px;">${sessionScope.yisheng.yishengSex }
						   </td>
					    </tr>
					    <tr>
						   <td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 12px;">
						   ...
						   <td bgcolor="#FFFFFF" colspan=3>
							  &nbsp;
							  <font style="font-size: 12px;" >${sessionScope.yisheng.yishengZhicheng }
						   </td>
					    </tr>
					    <tr>
						   <td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 12px;">
						   ...
						   <td bgcolor="#FFFFFF" colspan=3>
							  &nbsp;
							  <font style="font-size: 12px;">${sessionScope.yisheng.yishengZhuanchang }
						   </td>
					    </tr>
					    <tr>
						   <td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 12px;">
						   ...
						   <td bgcolor="#FFFFFF" colspan=3>
							  &nbsp;
							  <font style="font-size: 12px;">${sessionScope.yisheng.yishengJianjie }
						   </td>
					    </tr>
					    <tr>
